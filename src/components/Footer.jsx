            ...
            <footer>
                <div className="flex flex-col lg:flex-row lg:gap-5">
                    <div className="flex flex-col justify-center items-center flex-2 bg-gray-200 rounded-t-3xl ">
                        ...
                        <section class="container mx-auto px-4 lg:px-10 py-8 lg:py-16 bg-gray-100 rounded-lg shadow-md">
                            <h2 class="text-3xl text-center text-gray-800 font-medium mb-8">What We Offer</h2>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                <div class="flex flex-col gap-4 items-center justify-center border border-gray-300 rounded-lg p-4 hover:shadow-lg">
                                    <i class="fas fa-info-circle text-4xl text-blue-500"></i>
                                    <h3 class="text-xl text-gray-800 font-medium mt-2">Our Info</h3>
                                    <p class="text-gray-600 text-base">
                                        <div class="flex flex-col gap-4">
                                            <p class="text-lg lg:text-xl font-medium">About</p>
                                            <p class="text-lg lg:text-xl font-medium">Homepage</p>
                                            <p class="text-lg lg:text-xl font-medium">Services</p>
                                        </div>
                                    </p>
                                </div>
                                <div class="flex flex-col gap-4 items-center justify-center border border-gray-300 rounded-lg p-4 hover:shadow-lg">
                                    <i class="fas fa-book-open text-4xl text-green-500"></i>
                                    <h3 class="text-xl text-gray-800 font-medium mt-2">Our Page</h3>
                                    <p class="text-gray-600 text-base">
                                        <div class="flex flex-col gap-4">
                                            <p class="text-lg lg:text-xl font-medium">abcde@gmail.com</p>
                                            <p class="text-lg lg:text-xl font-medium">+1999929993</p>
                                            <p class="text-lg lg:text-xl font-medium">1234 Street Name, City Name, United States</p>
                                        </div>
                                    </p>
                                </div>
                                <div class="flex flex-col gap-4 items-center justify-center border border-gray-300 rounded-lg p-4 hover:shadow-lg">
                                    <i class="fas fa-book-open text-4xl text-green-500"></i>
                                    <h3 class="text-xl text-gray-800 font-medium mt-2">Our Page</h3>
                                    <p class="text-gray-600 text-base">Learn more about us and our mission.</p>
                                </div>
                            </div>
                        </section>
